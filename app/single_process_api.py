...
@router.post("/api/zerosinglebatch")
def zerosinglebatch():
    print("Zeroint batch")
    backend_variables.state["single_batch_current"] = 1
    backend_variables.websocket_payload['single_current_batch'] = 1

@router.post("/api/zerosinglecount")
def zerosinglecount():
    print("Zeroint count")
    backend_variables.state["single_total_current"] = 1
    backend_variables.websocket_payload['single_current_count'] = 1